		...
		<li>
		 <div class="slide-holder" style="background:  url('{{ asset(env('THEME')) }}/images/{{ $slider->img }}') no-repeat center center" style="height:483px;">
		  <div class="slide-content-holder inner" style="height:483px;">
	  		@if($i%2 !== 0)
	  			<div class="slide-content-holder-content" style="position: absolute; top: 12%; left: 7%; width: 40%;">
	  		@else
	  				<div class="slide-content-holder-content" style="position: absolute; top: 22%; right: 15%; width: 50%;">
	  		@endif
			...
			<script type="text/javascript">
			    jQuery(document).ready(function($){
			        ...
			        var     yit_slider_cycle_fx = 'easing',
			                ...
			                yit_slider_cycle_timeout = 10000,
