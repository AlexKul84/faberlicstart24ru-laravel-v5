                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="{{ asset(env('APP_URL')) }}" title="Faberlic-start24"><img src="{{ asset(env('THEME')) }}/images/logo.png" title="faberlic" alt="логототип компании Фаберлик" /></a>
                        </div>
                        <!-- END LOGO -->

                        <div id="sidebar-header" class="group">
                            <div class="widget-first widget yit_text_quote">
                                <blockquote class="text-quote-quote"><a href="{{ asset(env('REGISTER')) }}" onclick="ym(69596722,'reachGoal','REGISTRATION'); return true;" title="registration">Регистрация</a></blockquote>
                            </div>
                        </div>
